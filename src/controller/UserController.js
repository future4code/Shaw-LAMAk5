...
var UserController = /** @class */ (function () {
    function UserController(userBusiness) {
        ...
        this.createUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name_1, email, password, role, input, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userBusiness.createUser(input)];
                    case 1:
                        token = _b.sent();
        ...
        this.login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, input, token, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, this.userBusiness.getUserByEmail(input)];
                    case 1:
                        token = _b.sent();
