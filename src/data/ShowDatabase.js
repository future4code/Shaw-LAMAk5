...
var ShowDatabase = /** @class */ (function (_super) {
    __extends(ShowDatabase, _super);
    function ShowDatabase() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.insertShow = function (id, show) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
        ...
        _this.getAllShow = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        _this.getShowDay = function (week_day) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.getConnection()
                                .select("lama_bandas.name", "lama_bandas.music_genre", "lama_shows.start_time", "lama_shows.end_time")
