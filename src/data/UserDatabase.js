...
var UserDatabase = /** @class */ (function (_super) {
    ...
    function UserDatabase() {
        ...
        _this.signup = function (id, name, email, password, role) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
        ...
        _this.getUserByEmail = function (email) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        result = _a.sent();
                        if (result[0]) {
                            return [2 /*return*/, (0, User_1.toUserModel)(result[0])];
                        }
                        else {
    ...
    UserDatabase.TABLE_NAME = "lama_usuarios";
    return UserDatabase;
